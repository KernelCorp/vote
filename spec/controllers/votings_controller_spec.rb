...
describe VotingsController do
  ...
  context 'with other voting' do
    it '#create' do
      ...
      post :create, { "voting"=>{ "type"=>"other_voting", "name"=>"Название", "description"=>"Описание", "custom_background_color"=>"#e7e7e7", "custom_head_color"=>"#2c728d", "how_participate"=>"Как участвовать", "start_date"=>"22/02/2014", "max_users_count"=>"", "way_to_complete"=>"date", "end_date"=>"28/02/2014", "points_limit"=>"0", "social_actions_attributes"=>{ "1392977462632"=>{ "type"=>"Social::Action::Vk", "like_points"=>"1", "repost_points"=>"10", "_destroy"=>"false" } }, "other_actions_attributes"=>{ "1392977466459"=>{ "name"=>"Действие", "points"=>"1", "_destroy"=>"false" } } }, "start_date_hour"=>"5", "end_date_hour"=>"5", "commit"=>"Сохранить и отправить на проверку" }
