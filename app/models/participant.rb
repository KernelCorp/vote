class Participant < User
  ...
  has_many :social_posts, foreign_key: :participant_id, dependent: :destroy, class_name: 'Social::Post::Base'

  has_many :social_profiles, class_name: 'Social::Profile', dependent: :destroy
